...
const contentItemData = [
  {
    text: '24 years old energetic, hard-working programmer. I love travelling, doing sports, watching movies. Tookpart in the work and travel program.',
    imgHeight: 270,
    imgWidth: 200,
    textFirst: true,
    src: [good, bad],
  ...
  {
    text: 'Education - Kazan Federal University, institute of economic and financial management, specialist ofeconomical security, years: 2016-2021, also - certificate udemy react and certificate udemy node JS',
    imgHeight: 300,
    imgWidth: 200,
    textFirst: false,
    src: [education],
  ...
  {
    text: 'Experience - 2+ year commercial development, over 10 commercial projects including development of pharmacyapps, functional implementation based on gnosis chain, develop new user-facing features, build reusablecode and libraries for future use, optimize application for maximum speed and scalability',
    imgHeight: 220,
    imgWidth: 300,
    textFirst: true,
    src: [experience],
